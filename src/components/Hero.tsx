...
export function Hero() {
  ...
  return (
    <section className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden px-6 pt-20">
      ...
      <div className="pointer-events-none absolute right-4 top-1/2 z-1 select-none -translate-y-1/2 -rotate-2 opacity-10 blur-[0.5px] sm:right-12">
        <span
      ...
      {/* Ambient Glow Blob */}
      <div
        className="pointer-events-none absolute left-1/2 top-1/2 z-1 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-30 blur-[120px]"
        style={{
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        >
          <a
            href="#projects"
            className="magnetic group relative overflow-hidden rounded-full border border-amber-500 bg-amber-500 px-8 py-3.5 font-mono text-sm font-semibold uppercase tracking-widest text-[#050508] transition-all hover:bg-amber-400 hover:shadow-xl hover:shadow-amber-500/25"
          >
      ...
      <motion.a
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 text-gray-500 hover:text-amber-400 transition-colors"
